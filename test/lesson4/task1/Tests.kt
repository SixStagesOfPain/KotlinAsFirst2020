...
class Tests {
    ...
    @Test
    fun reverList() {
        assertEquals(mutableListOf(5, 4, 3, 2, 1), revertList(mutableListOf(1, 2, 3, 4, 5)))
    ...
    fun roman() {
        ...
        assertEquals("MMMMMMMMMMM", roman(11000))
    ...
    fun russian() {
        ...
        assertEquals("триста тысяч один", russian(300001))
